...
<head>
    <meta charset="utf-8">
    <title>Maya 2.0 - Module Modify</title>
...
<section>
    <div class="registermodule">
        <br><br>
        <form class="registermodule_form" name ="form" action="StaffModifyProcess.jsp" method="post">
            <br>
            <h1>Module Modify</h1>
            <input type="hidden" value="<%=request.getParameter("moduleno")%>" name="moduleno"/>
            <input type="hidden" value="<%=request.getParameter("moduleid")%>" name="moduleidbefore"/>
            <input type="hidden" value="<%=request.getParameter("moduleocc")%>" name="moduleoccbefore"/>
            <input type="hidden" value="<%=request.getParameter("moduletype")%>" name="moduletypebefore"/>
